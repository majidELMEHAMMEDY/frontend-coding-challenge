...
import { CardWraper , Avatar, Description, Badge, SubmissionDetails} from './styles';
    ...
    return (
        <CardWraper as="a" href={html_url} target="_blank" rel="noopener noreferrer">
            ...
            <Description>
                ...
                <SubmissionDetails> submitted {GetDateInterval(pushed_at)} days ago by {login} </SubmissionDetails>
            </Description>
        </CardWraper> 
    );
};
